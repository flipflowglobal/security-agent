---
name: driftnet
description: Passively extracts and displays images observed in sniffed network traffic.
...
Passively extracts and displays images observed in sniffed network traffic.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `driftnet` must
