---
name: cewl
description: Custom Word List generator; crawls a website's text to build a target-specific password wordlist.
...
Custom Word List generator; crawls a website's text to build a target-specific password wordlist.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `cewl` must
