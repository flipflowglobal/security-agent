---
name: aircrack-ng
description: Suite for auditing Wi-Fi security: packet capture, WEP/WPA-PSK key recovery, and injection testing.
...
Suite for auditing Wi-Fi security: packet capture, WEP/WPA-PSK key recovery, and injection testing.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `aircrack-ng` must
