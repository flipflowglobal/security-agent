---
name: wifite
description: Automates the aircrack-ng suite of attacks across multiple Wi-Fi networks in a single run.
...
Automates the aircrack-ng suite of attacks across multiple Wi-Fi networks in a single run.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `wifite` must
