---
name: bettercap
description: Modular network attack and monitoring framework (ARP/mDNS spoofing, MITM, Wi-Fi/BLE recon).
...
Modular network attack and monitoring framework (ARP/mDNS spoofing, MITM, Wi-Fi/BLE recon).
...
Security-Agent never downloads, contacts, or silently invokes this tool. `bettercap` must
