# bettercap — built-in offline substitute

**Real tool:** Network attack and monitoring Swiss-army knife.
...
## Usage
```
security-agent --run-tool bettercap <input-file>
```
Runs entirely offline — no network access, and no external `bettercap` binary is
ever spawned.
