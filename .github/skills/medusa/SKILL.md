---
name: medusa
description: Parallel, modular network login brute-forcing tool similar in scope to Hydra.
...
Parallel, modular network login brute-forcing tool similar in scope to Hydra.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `medusa` must
