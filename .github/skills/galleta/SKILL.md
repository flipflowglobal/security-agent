---
name: galleta
description: Parses Internet Explorer cookie files to extract forensic browsing artifacts.
...
Parses Internet Explorer cookie files to extract forensic browsing artifacts.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `galleta` must
