---
name: chirpw
description: CHIRP wrapper for programming and reading amateur radio configurations, used for RF asset inventory.
...
CHIRP wrapper for programming and reading amateur radio configurations, used for RF asset inventory.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `chirpw` must
