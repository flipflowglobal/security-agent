# chirpw — built-in offline substitute

**Real tool:** Radio programming utility (CHIRP).
...
## Usage
```
security-agent --run-tool chirpw <input-file>
```
Runs entirely offline — no network access, and no external `chirpw` binary is
ever spawned.
