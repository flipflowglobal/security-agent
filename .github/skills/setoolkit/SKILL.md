---
name: setoolkit
description: Social-Engineer Toolkit; builds phishing and social-engineering attack vectors and payload delivery scenarios.
...
Social-Engineer Toolkit; builds phishing and social-engineering attack vectors and payload delivery scenarios.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `setoolkit` must
