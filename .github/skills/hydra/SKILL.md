---
name: hydra
description: Fast network login brute-forcer supporting dozens of protocols (SSH, FTP, HTTP forms, RDP, and more).
...
Fast network login brute-forcer supporting dozens of protocols (SSH, FTP, HTTP forms, RDP, and more).
...
Security-Agent never downloads, contacts, or silently invokes this tool. `hydra` must
