# nuclei — built-in offline substitute

**Real tool:** Template-driven vulnerability scanner.
...
## Usage
```
security-agent --run-tool nuclei <input-file>
```
Runs entirely offline — no network access, and no external `nuclei` binary is
ever spawned.
