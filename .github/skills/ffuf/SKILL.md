---
name: ffuf
description: Fast web fuzzer for directories, parameters, virtual hosts, and more, using flexible wordlist input.
...
Fast web fuzzer for directories, parameters, virtual hosts, and more, using flexible wordlist input.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `ffuf` must
