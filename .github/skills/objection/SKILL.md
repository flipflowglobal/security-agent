---
name: objection
description: Runtime mobile exploration and instrumentation toolkit built on Frida for no-jailbreak/no-root workflows.
...
Runtime mobile exploration and instrumentation toolkit built on Frida for no-jailbreak/no-root workflows.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `objection` must
