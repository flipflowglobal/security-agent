# zenmap — built-in offline substitute

**Real tool:** Graphical front end for nmap.
...
## Usage
```
security-agent --run-tool zenmap <input-file>
```
Runs entirely offline — no network access, and no external `zenmap` binary is
ever spawned.
