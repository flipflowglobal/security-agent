---
name: zenmap
description: Official graphical front-end for Nmap, useful for visualizing scan results and network topology.
...
Official graphical front-end for Nmap, useful for visualizing scan results and network topology.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `zenmap` must
