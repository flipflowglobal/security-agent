# ncrack — built-in offline substitute

**Real tool:** High-speed network authentication cracker.
...
## Usage
```
security-agent --run-tool ncrack <input-file>
```
Runs entirely offline — no network access, and no external `ncrack` binary is
ever spawned.
