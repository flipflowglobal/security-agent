---
name: ncrack
description: Network authentication-cracking tool built for large-scale, high-speed credential testing.
...
Network authentication-cracking tool built for large-scale, high-speed credential testing.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `ncrack` must
