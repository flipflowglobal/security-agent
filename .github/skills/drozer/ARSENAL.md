# drozer — built-in offline substitute

**Real tool:** Android app security assessment framework.
...
## Usage
```
security-agent --run-tool drozer <input-file>
```
Runs entirely offline — no network access, and no external `drozer` binary is
ever spawned.
