---
name: ettercap
description: Classic MITM tool for LAN traffic interception, ARP poisoning, and protocol dissection.
...
Classic MITM tool for LAN traffic interception, ARP poisoning, and protocol dissection.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `ettercap` must
