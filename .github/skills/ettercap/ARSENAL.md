# ettercap — built-in offline substitute

**Real tool:** Man-in-the-middle and sniffing suite.
...
## Usage
```
security-agent --run-tool ettercap <input-file>
```
Runs entirely offline — no network access, and no external `ettercap` binary is
ever spawned.
