---
name: httrack
description: Website copier that mirrors a site's structure and assets locally for offline analysis.
...
Website copier that mirrors a site's structure and assets locally for offline analysis.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `httrack` must
