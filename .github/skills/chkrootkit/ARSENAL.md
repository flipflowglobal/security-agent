# chkrootkit — built-in offline substitute

**Real tool:** Local rootkit detector.
...
## Usage
```
security-agent --run-tool chkrootkit <input-file>
```
Runs entirely offline — no network access, and no external `chkrootkit` binary is
ever spawned.
