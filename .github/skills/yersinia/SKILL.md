---
name: yersinia
description: Layer 2 attack tool for testing weaknesses in networking protocols such as STP, DHCP, and VTP.
...
Layer 2 attack tool for testing weaknesses in networking protocols such as STP, DHCP, and VTP.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `yersinia` must
