---
name: pyrit
description: Batch-processes WPA/WPA2-PSK handshakes against large password lists, optionally GPU-accelerated.
...
Batch-processes WPA/WPA2-PSK handshakes against large password lists, optionally GPU-accelerated.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `pyrit` must
