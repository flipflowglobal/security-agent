# pyrit — built-in offline substitute

**Real tool:** GPU WPA-PSK handshake cracker.
...
## Usage
```
security-agent --run-tool pyrit <input-file>
```
Runs entirely offline — no network access, and no external `pyrit` binary is
ever spawned.
