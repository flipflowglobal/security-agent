# dex2jar — built-in offline substitute

**Real tool:** Android DEX-to-JAR converter.
...
## Usage
```
security-agent --run-tool dex2jar <input-file>
```
Runs entirely offline — no network access, and no external `dex2jar` binary is
ever spawned.
