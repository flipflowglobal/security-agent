---
name: john
description: John the Ripper; CPU-based offline password cracker supporting many hash and cipher formats.
...
John the Ripper; CPU-based offline password cracker supporting many hash and cipher formats.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `john` must
