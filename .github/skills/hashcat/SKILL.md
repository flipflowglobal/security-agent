---
name: hashcat
description: GPU-accelerated password-recovery tool supporting a very wide range of hash algorithms and attack modes.
...
GPU-accelerated password-recovery tool supporting a very wide range of hash algorithms and attack modes.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `hashcat` must
