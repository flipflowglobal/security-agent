# amass — built-in offline substitute

**Real tool:** Attack-surface and subdomain enumeration.
...
## Usage
```
security-agent --run-tool amass <input-file>
```
Runs entirely offline — no network access, and no external `amass` binary is
ever spawned.
