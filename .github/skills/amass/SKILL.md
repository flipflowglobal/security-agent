---
name: amass
description: In-depth attack-surface mapping tool combining passive and active subdomain/asset enumeration.
...
In-depth attack-surface mapping tool combining passive and active subdomain/asset enumeration.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `amass` must
