---
name: evil-winrm
description: Remote shell client for exploiting or administering Windows hosts over WinRM with captured or valid credentials.
...
Remote shell client for exploiting or administering Windows hosts over WinRM with captured or valid credentials.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `evil-winrm` must
