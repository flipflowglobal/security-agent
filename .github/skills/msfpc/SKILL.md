---
name: msfpc
description: "Metasploit Payload Creator" — wrapper script that quickly generates msfvenom payloads for common platforms.
...
"Metasploit Payload Creator" — wrapper script that quickly generates msfvenom payloads for common platforms.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `msfpc` must
