# msfpc — built-in offline substitute

**Real tool:** MSFvenom payload creator wrapper.
...
## Usage
```
security-agent --run-tool msfpc <input-file>
```
Runs entirely offline — no network access, and no external `msfpc` binary is
ever spawned.
