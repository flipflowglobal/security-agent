---
name: ike-scan
description: Discovers and fingerprints IKE/IPsec VPN endpoints and can test for weak pre-shared-key configurations.
...
Discovers and fingerprints IKE/IPsec VPN endpoints and can test for weak pre-shared-key configurations.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `ike-scan` must
