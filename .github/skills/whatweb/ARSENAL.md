# whatweb — built-in offline substitute

**Real tool:** Web technology fingerprinter.
...
## Usage
```
security-agent --run-tool whatweb <input-file>
```
Runs entirely offline — no network access, and no external `whatweb` binary is
ever spawned.
