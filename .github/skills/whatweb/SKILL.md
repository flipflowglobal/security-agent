---
name: whatweb
description: Web technology fingerprinting tool that identifies CMS, frameworks, servers, and analytics platforms.
...
Web technology fingerprinting tool that identifies CMS, frameworks, servers, and analytics platforms.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `whatweb` must
