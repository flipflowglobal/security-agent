---
name: msfconsole
description: Primary console interface to the Metasploit Framework for developing and running exploit modules.
...
Primary console interface to the Metasploit Framework for developing and running exploit modules.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `msfconsole` must
