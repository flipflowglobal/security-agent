# msfconsole — built-in offline substitute

**Real tool:** Metasploit Framework exploitation console.
...
## Usage
```
security-agent --run-tool msfconsole <input-file>
```
Runs entirely offline — no network access, and no external `msfconsole` binary is
ever spawned.
