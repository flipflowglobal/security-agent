---
name: nikto
description: Web server scanner that checks for dangerous files, outdated software, and common misconfigurations.
...
Web server scanner that checks for dangerous files, outdated software, and common misconfigurations.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `nikto` must
