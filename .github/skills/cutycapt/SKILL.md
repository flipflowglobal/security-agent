---
name: cutycapt
description: Command-line tool that renders a URL and saves a screenshot of the page (WebKit-based).
...
Command-line tool that renders a URL and saves a screenshot of the page (WebKit-based).
...
Security-Agent never downloads, contacts, or silently invokes this tool. `cutycapt` must
