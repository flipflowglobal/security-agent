# cutycapt — built-in offline substitute

**Real tool:** Headless web page screenshot capture.
...
## Usage
```
security-agent --run-tool cutycapt <input-file>
```
Runs entirely offline — no network access, and no external `cutycapt` binary is
ever spawned.
