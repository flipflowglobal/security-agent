---
name: tcpdump
description: Command-line packet capture tool that sniffs and filters live network traffic using BPF expressions.
...
Command-line packet capture tool that sniffs and filters live network traffic using BPF expressions.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `tcpdump` must
