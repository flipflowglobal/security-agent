---
name: crunch
description: Generates wordlists from a defined character set and pattern for use with password-cracking tools.
...
Generates wordlists from a defined character set and pattern for use with password-cracking tools.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `crunch` must
