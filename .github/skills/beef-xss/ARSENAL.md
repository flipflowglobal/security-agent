# beef-xss — built-in offline substitute

**Real tool:** Browser exploitation framework.
...
## Usage
```
security-agent --run-tool beef-xss <input-file>
```
Runs entirely offline — no network access, and no external `beef-xss` binary is
ever spawned.
