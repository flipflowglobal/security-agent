# apkleaks — built-in offline substitute

**Real tool:** APK secret/endpoint scanner.
...
## Usage
```
security-agent --run-tool apkleaks <input-file>
```
Runs entirely offline — no network access, and no external `apkleaks` binary is
ever spawned.
