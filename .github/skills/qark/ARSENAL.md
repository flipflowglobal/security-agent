# qark — built-in offline substitute

**Real tool:** Android source/APK vulnerability scanner.
...
## Usage
```
security-agent --run-tool qark <input-file>
```
Runs entirely offline — no network access, and no external `qark` binary is
ever spawned.
