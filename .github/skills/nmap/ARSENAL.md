# nmap — built-in offline substitute

**Real tool:** Network host/service/port discovery scanner.
...
## Usage
```
security-agent --run-tool nmap <input-file>
```
Runs entirely offline — no network access, and no external `nmap` binary is
ever spawned.
