---
name: mfoc
description: Offline/online Mifare Classic key-recovery tool using the "nested" and "darkside" cryptographic attacks.
...
Offline/online Mifare Classic key-recovery tool using the "nested" and "darkside" cryptographic attacks.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `mfoc` must
