# trueseeing — built-in offline substitute

**Real tool:** Android APK vulnerability scanner.
...
## Usage
```
security-agent --run-tool trueseeing <input-file>
```
Runs entirely offline — no network access, and no external `trueseeing` binary is
ever spawned.
