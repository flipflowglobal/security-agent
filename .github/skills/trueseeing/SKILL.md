---
name: trueseeing
description: Static/dynamic Android app vulnerability scanner with automated fix suggestions.
...
Static/dynamic Android app vulnerability scanner with automated fix suggestions.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `trueseeing` must
