---
name: wfuzz
description: Flexible web-application fuzzer for parameters, headers, and payload injection points.
...
Flexible web-application fuzzer for parameters, headers, and payload injection points.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `wfuzz` must
