# wfuzz — built-in offline substitute

**Real tool:** Web content and parameter fuzzer.
...
## Usage
```
security-agent --run-tool wfuzz <input-file>
```
Runs entirely offline — no network access, and no external `wfuzz` binary is
ever spawned.
