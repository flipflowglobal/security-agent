# dmitry — built-in offline substitute

**Real tool:** Deepmagic host information gatherer.
...
## Usage
```
security-agent --run-tool dmitry <input-file>
```
Runs entirely offline — no network access, and no external `dmitry` binary is
ever spawned.
