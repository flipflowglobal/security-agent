---
name: ophcrack
description: Windows password auditing tool using precomputed rainbow tables for LM/NTLM hashes.
...
Windows password auditing tool using precomputed rainbow tables for LM/NTLM hashes.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `ophcrack` must
