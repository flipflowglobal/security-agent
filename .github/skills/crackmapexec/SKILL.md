---
name: crackmapexec
description: Post-exploitation tool for enumerating and attacking Windows/Active Directory networks over SMB, WinRM, and related protocols.
...
Post-exploitation tool for enumerating and attacking Windows/Active Directory networks over SMB, WinRM, and related protocols.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `crackmapexec` must
