...
description: Linux screen-recording utility, useful for capturing proof-of-concept or demonstration video during authorized testing.
...
Linux screen-recording utility, useful for capturing proof-of-concept or demonstration video during authorized testing.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `recordmydesktop` must
