# mobsf — built-in offline substitute

**Real tool:** Mobile Security Framework (static/dynamic).
...
## Usage
```
security-agent --run-tool mobsf <input-file>
```
Runs entirely offline — no network access, and no external `mobsf` binary is
ever spawned.
