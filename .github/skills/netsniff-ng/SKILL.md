---
name: netsniff-ng
description: High-performance packet capture and replay toolkit for Linux networking.
...
High-performance packet capture and replay toolkit for Linux networking.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `netsniff-ng` must
