---
name: wpscan
description: WordPress-specific vulnerability scanner identifying core, plugin, theme issues, and weak credentials.
...
WordPress-specific vulnerability scanner identifying core, plugin, theme issues, and weak credentials.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `wpscan` must
