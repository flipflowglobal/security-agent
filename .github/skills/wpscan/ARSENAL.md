# wpscan — built-in offline substitute

**Real tool:** WordPress vulnerability scanner.
...
## Usage
```
security-agent --run-tool wpscan <input-file>
```
Runs entirely offline — no network access, and no external `wpscan` binary is
ever spawned.
