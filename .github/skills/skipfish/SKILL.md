---
name: skipfish
description: Automated, recursive web-application security reconnaissance and vulnerability scanner.
...
Automated, recursive web-application security reconnaissance and vulnerability scanner.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `skipfish` must
