# jadx — built-in offline substitute

**Real tool:** Android DEX-to-Java decompiler.
...
## Usage
```
security-agent --run-tool jadx <input-file>
```
Runs entirely offline — no network access, and no external `jadx` binary is
ever spawned.
