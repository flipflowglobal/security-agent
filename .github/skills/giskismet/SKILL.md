---
name: giskismet
description: Correlates Kismet capture data with GPS coordinates for wireless-network mapping (e.g. wardriving visualization).
...
Correlates Kismet capture data with GPS coordinates for wireless-network mapping (e.g. wardriving visualization).
...
Security-Agent never downloads, contacts, or silently invokes this tool. `giskismet` must
