# giskismet — built-in offline substitute

**Real tool:** Kismet survey visualizer/reporter.
...
## Usage
```
security-agent --run-tool giskismet <input-file>
```
Runs entirely offline — no network access, and no external `giskismet` binary is
ever spawned.
