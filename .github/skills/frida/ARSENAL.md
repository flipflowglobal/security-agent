# frida — built-in offline substitute

**Real tool:** Dynamic instrumentation toolkit.
...
## Usage
```
security-agent --run-tool frida <input-file>
```
Runs entirely offline — no network access, and no external `frida` binary is
ever spawned.
