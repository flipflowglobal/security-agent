# mariana-trench — built-in offline substitute

**Real tool:** Android/Java dataflow security analyzer.
...
## Usage
```
security-agent --run-tool mariana-trench <input-file>
```
Runs entirely offline — no network access, and no external `mariana-trench` binary is
ever spawned.
