---
name: netdiscover
description: Active/passive ARP reconnaissance tool for discovering live hosts on a local network segment.
...
Active/passive ARP reconnaissance tool for discovering live hosts on a local network segment.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `netdiscover` must
