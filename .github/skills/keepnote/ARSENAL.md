# keepnote — built-in offline substitute

**Real tool:** KeepNote notebook reader.
...
## Usage
```
security-agent --run-tool keepnote <input-file>
```
Runs entirely offline — no network access, and no external `keepnote` binary is
ever spawned.
