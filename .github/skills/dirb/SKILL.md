---
name: dirb
description: Classic web-content scanner that brute-forces directories and files using a wordlist.
...
Classic web-content scanner that brute-forces directories and files using a wordlist.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `dirb` must
