# apksigner — built-in offline substitute

**Real tool:** Android APK signature verifier.
...
## Usage
```
security-agent --run-tool apksigner <input-file>
```
Runs entirely offline — no network access, and no external `apksigner` binary is
ever spawned.
