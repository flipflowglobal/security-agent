---
name: rcrack
description: RainbowCrack lookup client that recovers plaintext passwords from precomputed rainbow tables.
...
RainbowCrack lookup client that recovers plaintext passwords from precomputed rainbow tables.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `rcrack` must
