# thc-ipv6 — built-in offline substitute

**Real tool:** IPv6 protocol attack toolkit.
...
## Usage
```
security-agent --run-tool thc-ipv6 <input-file>
```
Runs entirely offline — no network access, and no external `thc-ipv6` binary is
ever spawned.
