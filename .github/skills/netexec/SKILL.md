---
name: netexec
description: Network service exploitation and enumeration tool (successor to CrackMapExec) for Active Directory environments.
...
Network service exploitation and enumeration tool (successor to CrackMapExec) for Active Directory environments.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `netexec` must
