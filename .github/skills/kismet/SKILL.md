---
name: kismet
description: Wireless network detector, sniffer, and intrusion-detection tool for Wi-Fi, Bluetooth, and SDR.
...
Wireless network detector, sniffer, and intrusion-detection tool for Wi-Fi, Bluetooth, and SDR.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `kismet` must
