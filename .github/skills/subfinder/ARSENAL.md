# subfinder — built-in offline substitute

**Real tool:** Passive subdomain discovery.
...
## Usage
```
security-agent --run-tool subfinder <input-file>
```
Runs entirely offline — no network access, and no external `subfinder` binary is
ever spawned.
