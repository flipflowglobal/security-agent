---
name: termineter
description: Framework for testing smart meters over the ANSI C12.18/C12.19 optical/serial protocol.
...
Framework for testing smart meters over the ANSI C12.18/C12.19 optical/serial protocol.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `termineter` must
