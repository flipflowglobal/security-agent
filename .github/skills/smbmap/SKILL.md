---
name: smbmap
description: Enumerates SMB share permissions and contents across a network using provided or null credentials.
...
Enumerates SMB share permissions and contents across a network using provided or null credentials.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `smbmap` must
