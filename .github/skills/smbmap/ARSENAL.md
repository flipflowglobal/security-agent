# smbmap — built-in offline substitute

**Real tool:** SMB share enumeration and access checker.
...
## Usage
```
security-agent --run-tool smbmap <input-file>
```
Runs entirely offline — no network access, and no external `smbmap` binary is
ever spawned.
