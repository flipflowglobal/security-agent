---
name: mfterm
description: Interactive terminal for reading, editing, and analyzing Mifare Classic RFID card dumps.
...
Interactive terminal for reading, editing, and analyzing Mifare Classic RFID card dumps.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `mfterm` must
