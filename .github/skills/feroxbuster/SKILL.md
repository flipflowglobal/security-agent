---
name: feroxbuster
description: Fast, recursive content-discovery tool for enumerating web directories and files.
...
Fast, recursive content-discovery tool for enumerating web directories and files.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `feroxbuster` must
