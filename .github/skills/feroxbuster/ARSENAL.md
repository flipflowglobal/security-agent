# feroxbuster — built-in offline substitute

**Real tool:** Recursive content-discovery brute-forcer.
...
## Usage
```
security-agent --run-tool feroxbuster <input-file>
```
Runs entirely offline — no network access, and no external `feroxbuster` binary is
ever spawned.
