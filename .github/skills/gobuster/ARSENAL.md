# gobuster — built-in offline substitute

**Real tool:** Directory, DNS, and vhost brute-forcer.
...
## Usage
```
security-agent --run-tool gobuster <input-file>
```
Runs entirely offline — no network access, and no external `gobuster` binary is
ever spawned.
