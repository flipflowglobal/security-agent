---
name: gobuster
description: Fast directory/file, DNS subdomain, and vhost brute-forcing tool for web reconnaissance.
...
Fast directory/file, DNS subdomain, and vhost brute-forcing tool for web reconnaissance.
...
Security-Agent never downloads, contacts, or silently invokes this tool. `gobuster` must
