...
pub static REGISTRY: &[ActionSpec] = &[
    ...
    ActionSpec {
        name: "hash-id",
        command: "--hash-id",
        summary: "Identify a hash's algorithm and suggest cracking tools.",
        class: ActionClass::ReadOnly,
        network: false,
        arg: ArgKind::Text,
        triggers: &[
        ...
        examples: &[
            "identify the hash 5d41402abc4b2a76b9719d911017c592",
            "what hash type is this",
            "identify the hash $2a$10$N9qo8uLOickgx2ZMRZoMyeI",
        ],
    },
    ActionSpec {
        name: "password-strength",
        command: "--password-strength",
        summary: "Analyze a password's entropy and crack resistance.",
        class: ActionClass::ReadOnly,
        network: false,
        arg: ArgKind::Text,
        triggers: &[
        ...
        examples: &[
            ...
            "how strong is Tr0ub4dor&3",
            "analyze the password entropy",
        ],
    },
    ActionSpec {
        name: "gen-wordlist",
        command: "--gen-wordlist",
        summary: "Generate a targeted password wordlist for a target.",
        class: ActionClass::ReadOnly,
        network: false,
        arg: ArgKind::Text,
        triggers: &[
            "create a wordlist for the target",
            "generate a wordlist for the target",
            "create a wordlist",
            "generate a wordlist",
            "make a wordlist",
            "wordlist",
        ...
        examples: &[
            "create a wordlist for the target acme",
            "generate a wordlist for acme-corp",
            "make a wordlist for the engagement",
        ],
    },
    ActionSpec {
        name: "analyze-payload",
        command: "--analyze-payload",
        summary: "Analyze a payload for shellcode patterns and detection risk.",
        class: ActionClass::ReadOnly,
        network: false,
        arg: ArgKind::Text,
        triggers: &[
        ...
        examples: &[
            "analyze this payload bash -i",
            "analyze the reverse shell payload",
            "run a payload analysis on this command",
        ],
    },
    ActionSpec {
        name: "wps-pin",
        command: "--wps-pin",
        summary: "Analyze a WPS PIN for default or vulnerable status.",
        class: ActionClass::ReadOnly,
        network: false,
        arg: ArgKind::Text,
        triggers: &[
        ...
        examples: &[
            "check the wps pin 12345670",
            "analyze the wps pin 78901234",
            "is the wps pin vulnerable",
        ],
    },
    ActionSpec {
        name: "obfuscate-ps",
        command: "--obfuscate-ps",
        summary: "Apply PowerShell obfuscation techniques to a command.",
        class: ActionClass::ReadOnly,
        network: false,
        arg: ArgKind::Text,
        triggers: &[
            "obfuscate this powershell",
        ...
        examples: &[
            "obfuscate this powershell command IEX(New-Object Net.WebClient)",
